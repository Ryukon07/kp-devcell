        ...
        <body style="margin:0; padding:0; background-color:#0D1117; font-family: 'Segoe UI', Arial, sans-serif;">
          <div style="max-width:520px; margin:40px auto; background-color:#161B26; border-radius:16px; overflow:hidden; border:1px solid #232B3A;">
            ...
            <div style="background:linear-gradient(135deg,#0D1117 0%,#161B26 100%); padding:36px 40px 28px; border-bottom:1px solid #232B3A; text-align:center;">
              ...
              <div style="width:56px; height:56px; background:rgba(20,184,166,0.1); border:2px solid rgba(20,184,166,0.4); border-radius:50%; margin:0 auto 16px;">
                <span style="font-size:24px; line-height:56px;">🔐</span>
              </div>
              <h1 style="margin:0; color:#E8EAED; font-size:22px; font-weight:700;">Admin Access Granted</h1>
            ...
            <div style="padding:32px 40px;">
              ...
              <p style="margin:0 0 28px; color:#7E8590; font-size:14px; line-height:1.7;">
                You've been granted admin access to the <span style="color:#14B8A6;">KP Dev Cell</span> website. Use the credentials below to log in.
              </p>

              <!-- Credentials box -->
              <div style="background:#0D1117; border:1px solid #232B3A; border-radius:12px; overflow:hidden; margin-bottom:28px;">
                <div style="padding:12px 18px; border-bottom:1px solid #232B3A;">
                  <span style="color:#4B5563; font-size:11px; font-family:monospace;">credentials.env</span>
                </div>
              ...
              <div style="text-align:center; margin-bottom:28px;">
                <a href="https://kp-devcell.vercel.app/login"
                  style="display:inline-block; background:linear-gradient(135deg,#14B8A6,#0d9488); color:#0D1117; text-decoration:none; font-weight:700; font-size:13px; padding:13px 32px; border-radius:8px;">
                  → Login to Dashboard
                </a>
              </div>
            ...
            <div style="padding:20px 40px 28px; border-top:1px solid #232B3A; text-align:center;">
              <p style="margin:0 0 6px; color:#374151; font-size:11px; font-family:monospace;">KP DEV CELL — ADMIN SYSTEM</p>
              <p style="margin:0; color:#1f2937; font-size:11px;">If you did not expect this email, please ignore it.</p>
            </div>
